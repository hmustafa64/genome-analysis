---
title: "Corona Virus COVID-19 REPORT"
...
```{r}
head(report_03_20_2020)

```


```{r}
str(report_03_20_2020)
...
```{r}
time_series_confirmed_long %>% 
  filter (Country.Region %in% c("China","Japan", "United Kingdom",
...
static <- ggplot(subset(time_series_confirmed_long2,Date %in% seq(min(Date),max(Date),7)),
            ...
            borders("world", colour = NA, fill = "green") +
            theme_bw() +
